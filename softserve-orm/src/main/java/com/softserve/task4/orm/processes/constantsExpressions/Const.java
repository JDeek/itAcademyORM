package com.softserve.task4.orm.processes.constantsExpressions;

/**
 * Created by ${JDEEK} on ${11.11.2018}.
 */
public class Const {
    public static final String STRING_QUERY_END = ";";
    public static final String STRING_BEFORE_QUOTE = "`";
    public static final String STRING_AFTER_QUOTE = "` ";
    ...
    public static final String STRING_ADD_COLUMN= "INTO ";
    ...
    public static final String STRING_SELECT = " SELECT ";
    public static final String STRING_ALL_VALUES = " * ";
